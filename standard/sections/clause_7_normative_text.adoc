...
The WCMP record schema is based on the schema defined as part of _OGC API - Records - Part 1: Core: Requirements Class: Record Core_ and the associated information model.  WCMP records which
are valid to WCMP 2.0 schema are therefore valid to the _OGC API - Records_ record schema.
