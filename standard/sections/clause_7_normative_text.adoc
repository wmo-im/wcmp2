...
----
"providers": [
  "https://example.org/data-provider",
  {
    "identifier": "MSC",
    ...
    "contactInfo": {
      ...
      "email": {
        "office": "ecweather-meteo@ec.gc.ca"
      },
      "address": {
        "office": {
          "deliveryPoint": "77 Westmorland Street, Suite 260",
          "city": "Fredericton",
          "administriviaArea": "New Brunswick",
          "postalCode": "E3B 6Z3",
          "country": "Canada"
        }
      },
      ...
      "hoursOfService": "Monday to Friday, 1300h - 2100h UTC",
...
Based on the WMO Unified Policy for the International Exchange of Earth System Data (Resolution 1 (Cg-Ext(2021))) footnote:[https://library.wmo.int/doc_num.php?explnum_id=11113#page=9], exchanged data
are expressed as `+core+` or `+recommended+`.

include::../requirements/core/REQ_data_policy.adoc[]

If the resource is classified as `+recommended+`, it needs to be addressed if any additional conditions apply.  Conditions on use
are essential by the WMO Unified Data Policy, but for transparency and clarification any other conditions should also be addressed.
