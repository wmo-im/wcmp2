...
The WIS2 Topic Hierarchy is a required concept and is consistent with the topic as defined in distribution links
advertising broker services.

include::../requirements/core/REQ_topic_hierarchy.adoc[]
...
include::../recommendations/core/REC_themes.adoc[]
