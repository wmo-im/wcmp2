...
A WCMP record provides a description at the granularity of a dataset, which facilitates clearer
cataloguing and discovery workflow, in combination with data services or APIs, which provide
access/query/filter at a lower level of granularity (parameter, variable, spatiotemporal extents).
...
"themes": [
  {
    ...
    "scheme": "http://codes.wmo.int/grib2/codeflag/_4.2"
----
...
include::../recommendations/core/REQ_granularity.adoc[]
