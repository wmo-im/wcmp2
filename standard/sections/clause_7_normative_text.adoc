...
A WCMP record has to provide some distribution information regarding how to access and retrieve the data products (TODO check terminology to use the same all along the document). This information is specified by the Distribution information.
