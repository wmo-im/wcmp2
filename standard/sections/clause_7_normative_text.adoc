...
A WCMP record provides information regarding how to access and retrieve data and products. This information is specified by defining one or more links to corresponding data access services.
