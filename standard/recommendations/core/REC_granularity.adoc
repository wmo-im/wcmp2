...
^|C |When  dataset properties (parameters, variables, spatiotemporal extents) are made available via a data service or API, a WCMP record SHOULD provide templated links to facilitate easier data query/filter. See <<distribution>> section.
|===
