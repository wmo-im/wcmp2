...
include::sections/clause_7_identification.adoc[]

include::sections/clause_8_extents.adoc[]

include::sections/clause_9_data_policy.adoc[]

include::sections/clause_10_distribution.adoc[]
