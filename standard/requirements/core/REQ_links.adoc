...
^|G |A WCMP record `+links+` property SHALL include a valid link relation from IANA_ footnote:[https://www.iana.org/assignments/link-relations/link-relations.xml] or the WCMP link type codelist_ footnote:[https://github.com/wmo-im/wcmp2-codelists/blob/main/codelists/link-type.csv].
|===
