...
and valuable quality assessment rules beyond the rulesets put
forth by WCMP.

The core driver of WCMP KPIs is continuous improvement and usability of
...
The KPIs in this document are designed to help metadata providers curate discovery metadata and for GDCs to measure the quality 
...
pywcmp is provided to the community as a resource with continuous
