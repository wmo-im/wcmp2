...
This document is bound to the WCMP 2 specificationfootnote:[https://library.wmo.int/idurl/4/68731] and codelistsfootnote:[https://codes.wmo.int/wis]. Allother metadata specifications or representations are not in scope.
