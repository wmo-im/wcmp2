...
* https://wmo-im.github.io/wcmp2/standard/wcmp2-STABLE.html#_1_11_geospatial_and_temporal_extents[1.11 Geospatial and temporal extents]
...
|The begin date is before the end date, when there is an end date.
|1
