...
* https://wmo-im.github.io/wcmp2/standard/wcmp2-STABLE.html#_1_7_properties_title[1.7 Properties / Title]
...
|The title contains fewer than 3 acronyms (words with all uppercase letters)
|1
